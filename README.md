...
# HAI!!!       ![Visitor](https://visitor-badge.laobi.icu/badge?page_id=Retno-W-Septiani.Retno-W-Septiani)
...
- 👩‍🎓 I’m currently doing my PhD program at ![URI Badge](https://img.shields.io/badge/URI-University%20of%20Rhode%20Island-blue)

### **Interests**
🌧️ `Global Hydrology`|🌏 `Environmental Protection`
---|---|
💨 `Carbon Cycle`| 🗺️ `GIS` 
📡 `Remote Sensing` | ⛵ `Traveling` 
